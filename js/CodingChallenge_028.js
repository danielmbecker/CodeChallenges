...
function isValidWalk(walk) {
    let distanceN = walk.filter(e => e === 'n').length
    let distanceS = walk.filter(e => e === 's').length
    let distanceE = walk.filter(e => e === 'e').length
    let distanceW = walk.filter(e => e === 'w').length
    
    let totalDistance = distanceN + distanceS + distanceE + distanceW
